<?php
function utf8_entity_decode($string) {
...
if (extension_loaded('mbstring')) {
	...
	function utf8_convert_encoding($string) {
		mb_detect_order('ASCII, JIS, UTF-8, EUC-JP, SJIS, ISO-8859-9, ISO-8859-15, ISO-8859-1');

		$detect = mb_detect_encoding($string, implode(',', mb_detect_order()), true);
	...
	function utf8_convert_encoding($string) {
		return iconv('latin5', 'utf-8', $string);
	}
